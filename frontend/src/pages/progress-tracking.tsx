...
const ProgressTrackingList = () => {
  ...
  return (
    <>
      <SEO
        title={seo?.progressTracking?.title}
        description={seo?.progressTracking?.description}
        keywords={seo?.progressTracking?.keywords?.join(',')}
      />
      <Admin>
        <div className="container mx-auto mt-8 px-4">
          ...
          <Dialog open={dialogOpen} onClose={handleCloseDialog}>
            ...
            <DialogContent>
              <DialogContentText>
                Are you sure you want to delete this progress tracking? This
