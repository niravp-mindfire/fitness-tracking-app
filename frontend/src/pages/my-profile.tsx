...
const MyProfile = () => {
  ...
  return (
    <>
      <SEO
        title={seo?.myProfile?.title}
        description={seo?.myProfile?.description}
        keywords={seo?.myProfile?.keywords?.join(',')}
      />
      <Admin>
                        ...
                        <Grid container spacing={2}>
                          ...
                          <Grid item xs={12} sm={6}>
                            <Field
                              ...
                              disabled={isSubmitting}
                              helperText={
                                <ErrorMessage name="profile.lastName" />
                              }
                          ...
                          <Grid item xs={12} sm={6}>
                            <Field
                              ...
                              type="number"
                              helperText={
                                <ErrorMessage name="profile.height" />
                              }
                          ...
                          <Grid item xs={12} sm={6}>
                            <Field
                              ...
                              type="number"
                              helperText={
                                <ErrorMessage name="profile.weight" />
                              }
