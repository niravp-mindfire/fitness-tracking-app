...
challengesRouter.post('/', authenticateToken, challengeValidation, createChallenge);
challengesRouter.put('/:id', authenticateToken, challengeValidation, updateChallenge);
