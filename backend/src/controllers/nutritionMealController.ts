...
export const getNutritionMealById = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(200)
      .json(
        successResponse(nutritionMeal, 'Nutrition meal retrieved successfully')
      );
  } catch (error) {
...
export const getAllNutritionMeals = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json(errorResponse('Error fetching nutrition meals', error));
  }
};
  ...
  try {
    ...
    res
      ...
      .json(
        successResponse(
          savedNutritionMeal,
          'Nutrition meal created successfully'
        )
      );
  } catch (error) {
...
export const updateNutritionMeal = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(200)
      .json(
        successResponse(nutritionMeal, 'Nutrition meal updated successfully')
      );
  } catch (error) {
...
export const deleteNutritionMeal = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res
      .status(200)
      .json(successResponse(null, 'Nutrition meal deleted successfully'));
  } catch (error) {
